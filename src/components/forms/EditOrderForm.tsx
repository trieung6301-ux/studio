...
import { updateOrder, CreateOrderData, Order } from '@/lib/api/orders.api'
...
export default function EditOrderForm({ open, onOpenChange, onSuccess, order }: EditOrderFormProps) {
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Cập nhật thông tin đơn hàng. Thực hiện thay đổi ở các trường bên dưới.
          </DialogDescription>
        </DialogHeader>
